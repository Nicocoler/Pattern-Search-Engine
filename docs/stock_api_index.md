# 📈 股票数据接口功能索引目录 (AKShare)

> 朔哥哥，这是从完整的 `stock.md` 大文档中自动提取出的接口目录导航。您可以通过此目录快速了解所有可用的股票数据接口功能。

## 📂 接口树状分类导航

- **接口总数**：共收录 **372** 个股票数据接口
- **分类覆盖**：A股市场总貌、个股查询、实时行情、历史 K 线、分时数据、ESG 指标等多维度
- **详细文档**：[点击查看完整 stock.md](./stock.md)
...
- **AKShare 股票数据**
  - **A股**
    ...
    - **历史分笔数据**
      - **腾讯财经**
        - `stock_zh_a_tick_tx` : **每个交易日 16:00 提供当日数据; 如遇到数据缺失, 请使用 **ak.stock_zh_a_tick_163()** 接口(注意数据会有一定差异)**
    - **同行比较**
      - **成长性比较**
        - `stock_zh_growth_comparison_em` : **东方财富-行情中心-同行比较-成长性比较**
      - **估值比较**
        - `stock_zh_valuation_comparison_em` : **东方财富-行情中心-同行比较-估值比较**
      - **杜邦分析比较**
        - `stock_zh_dupont_comparison_em` : **东方财富-行情中心-同行比较-杜邦分析比较**
      - **公司规模**
        - `stock_zh_scale_comparison_em` : **东方财富-行情中心-同行比较-公司规模**
  - **A股-CDR**
    - **历史行情数据**
  ...
  - **股票质押**
    ...
    - **个股重要股东股权质押明细**
      - `stock_gpzy_individual_pledge_ratio_detail_em` : **东方财富网-数据中心-股权质押-个股**
    - **质押机构分布统计-证券公司**
  ...
  - **财经内容精选**
    - `stock_news_main_cx` : **财新网-财新数据通-最新**
  - **财报发行**
  ...
  - **新股数据**
    ...
    - **新股申购与中签-同花顺**
      - `stock_ipo_ths` : **同花顺-数据中心-新股申购与中签**
    - **新股申购与中签-港股-同花顺**
  ...
  - **基本面数据**
    ...
    - **沪深京 A 股个股公告**
      - `stock_individual_notice_report` : **东方财富网-数据中心-公告大全-个股**
    - **财务报表-新浪**
    ...
    - **财务报表-同花顺**
      - **资产负债表**
        - `stock_financial_debt_new_ths` : **同花顺-财务指标-资产负债表；替换 stock_financial_debt_ths 接口**
      - **利润表**
        - `stock_financial_benefit_new_ths` : **同花顺-财务指标-利润表；替换 stock_financial_benefit_ths 接口**
      - **现金流量表**
        - `stock_financial_cash_new_ths` : **同花顺-财务指标-现金流量表；替换 stock_financial_cash_ths 接口**
    - **财务报表-东财-已退市股票**
      - **资产负债表-按报告期**
    ...
    - **关键指标-同花顺**
      - `stock_financial_abstract_new_ths` : **同花顺-财务指标-重要指标；替换 stock_financial_abstract_ths 接口**
    - **主要指标-东方财富**
    ...
    - **IPO辅导信息**
      - `stock_ipo_tutor_em` : **东方财富网-数据中心-新股申购-IPO辅导信息**
    - **股票增发**
    ...
    - **首发申报信息**
      - `stock_ipo_declare_em` : **东方财富网-数据中心-新股申购-首发申报信息-首发申报企业信息**
    - **IPO审核信息**
      - **全部**
